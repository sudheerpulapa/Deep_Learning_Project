...
class TrainPipeline:
    ...
    def run_pipeline(self) -> None:
        ...
        try:
            ...
            model_evaluation_artifact: ModelEvaluationArtifact = self.start_model_evaluation(model_trainer_artifact, data_transformation_artifact)
            # Start model pushing
...
# Instantiate the TrainPipeline class and run the pipeline
